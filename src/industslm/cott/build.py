...
from industslm.model.llm.TimeSeriesFlamingoWithTrainableEncoder import (
...
from industslm.cott.encoders import CNNPatchEncoder, ChronosPatchEncoder
from industslm.cott.decoders import (
...
def register_cott_in_curriculum_trainer():
    ...
    Call this once at the top of your training script:
        ...
        from industslm.cott.build import register_cott_in_curriculum_trainer
